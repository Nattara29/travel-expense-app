...
-- ---------- ระดับตำแหน่งข้าราชการ/พนักงานส่วนท้องถิ่น 11 ระดับ ตามระเบียบกระทรวงมหาดไทยฯ
-- ---------- บวกพนักงานจ้าง/ลูกจ้างประจำ ซึ่งเบิกในอัตราเดียวกับระดับ 8 ลงมา ----------
insert into public.position_levels (name, sort_order) values
  ...
  ('พนักงานจ้าง / ลูกจ้างประจำ (เทียบเท่าระดับ 8 ลงมา)', 12)
